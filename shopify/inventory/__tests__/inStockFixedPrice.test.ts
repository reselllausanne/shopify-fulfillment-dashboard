...
describe("inStockFixedPrice", () => {
  ...
  it("resolves hoodie by SKU base with COGS 42", () => {
  ...
  it("resolves Audemars x Travis by title with COGS 40", () => {
    const r = resolveInStockFixedPrice({
