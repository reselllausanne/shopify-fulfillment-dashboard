    ...
    if (String(orderRow.deliveryType ?? "").toLowerCase() === "direct_delivery") {
      ...
      return NextResponse.json({
        ...
        order: {
          ...
          customerType: orderRow.customerType ?? null,
          customerName: orderRow.customerName ?? null,
          customerPostalCode: orderRow.customerPostalCode ?? null,
          customerCity: orderRow.customerCity ?? null,
          customerCountry: orderRow.customerCountry ?? null,
          customerCountryCode: orderRow.customerCountryCode ?? null,
          ...
          referencePerson: orderRow.referencePerson ?? null,
